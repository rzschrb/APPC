...
if option == "1":  # Celsius > Fahrenheit
    try:
        ...
        f = 9*c/5+32
        print("{:.1f}".format(c), "graus Celsius correspondem a", "{:.1f}".format(f), "graus Fahrenheit\n")
    ...
    try:
        ...
        c = 5/9*(f-32)
        print("{:.1f}".format(f), "graus Fahrenheit correspondem a", "{:.1f}".format(c), "graus Celsius\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        c = float(input("\n> Digite a temperatura em Celsius que deseja converter: "))
        k = c+275.15
        print("{:.1f}".format(c), "graus Celsius correspondem a", "{:.2f}".format(k), "graus Kelvin\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        ...
        c = k-275.15
        print("{:.2f}".format(k), "graus Kelvin correspondem a", "{:.1f}".format(c), "graus Celsius\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        c = float(input("\n> Digite a temperatura em Celsius que deseja converter: "))
        r = (c+275.15)*1.8
        print("{:.1f}".format(c), "graus Celsius correspondem a", "{:.2f}".format(r), "graus Rankine\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        ...
        c = (r/1.8)-275.15
        print("{:.2f}".format(r), "graus Rankine correspondem a", "{:.1f}".format(c), "graus Celsius\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        f = float(input("\n> Digite a temperatura em Fahrenheit que deseja converter: "))
        k = (f-32)*1.8+275.15
        print("{:.2f}".format(f), "graus Fahrenheit correspondem a", "{:.2f}".format(k), "graus Kelvin\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        k = float(input("\n> Digite a temperatura em Kelvin que deseja converter: "))
        f = (k-275.15)*1.8+32
        print("{:.2f}".format(k), "graus Kelvin correspondem a", "{:.2f}".format(f), "graus Fahrenheit\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        ...
        c = 5/9*(f-32)
        r = (c + 275.15) * 1.8
        print("{:.2f}".format(f), "graus Fahrenheit correspondem a", "{:.2f}".format(r), "graus Rankine\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        ...
        c = (r/1.8)-275.15
        f = 9 * c / 5 + 32
        print("{:.2f}".format(r), "graus Rankine correspondem a", "{:.2f}".format(f), "graus Fahrenheit\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        ...
        c = k-275.15
        r = (c + 275.15) * 1.8
        print("{:.2f}".format(k), "graus Kelvin correspondem a", "{:.2f}".format(r), "graus Rankine\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
    ...
    try:
        ...
        c = (r / 1.8) - 275.15
        k = c + 275.15
        print("{:.2f}".format(r), "graus Rankine correspondem a", "{:.2f}".format(k), "graus Kelvin\n")
        print("Obrigado por utilizar o programa")
    except ValueError:
        print("\nO valor informado não corresponde a uma temperatura válida")
else:
